...
* @Title: emby.js
*
* @Description: 瀏覽器中下載影片或外掛字幕 ( 如果影片有外掛字幕且選中，則下載外掛字幕文件，否則下載影片文件 )、使用 Shu 下載 ( 如果影片有外掛字幕，則下載全部外掛字幕 )、使用 iOS 版 VLC 下載 ( 如果影片有外掛字幕且選中，則下載外掛字幕文件，否則下載影片文件 )、使用 iOS 版 nPlayer 播放 ( 不支持外掛字幕 )、使用 VLC 播放 ( 支持選中的外掛字幕 )、使用 iOS 和 macOS 版 Infuse 播放 ( 不支持外掛字幕 )。
*
...
if ($request.url.indexOf('/Download') != -1){
  if($response.status==401){
    ...
    $httpClient.get({
      ...
      if (error) {
        $notification.post("影片信息獲取失敗️", "", error);
        $done();
      }else{
          ...
          if (media_source.Id == media_source_id) {
            ...
            switch(type)
            {
                case "shu_download":
                    ...
                    console.log("《" + video_data.SortName + "》 Shu 批量下載地址:\n" + shu_download_url + "\n");
                ...
                case "vlc_download":
                    ...
                    console.log("《" + video_data.SortName + "》 VLC 下載地址:\n" + vlc_download_url_scheme + "\n");
...
if ($request.url.indexOf('/web/modules/itemcontextmenu.js') != -1) {
    ...
    let replace = '&&commands.push({name:"\u0053\u0068\u0075\u0020\u4e0b\u8f09\u0020\u0028\u0020\u0069\u004f\u0053\u0020\u652f\u6301\u5916\u639b\u5b57\u5e55\u0020\u0029",id:"shu_download",icon:"download"})&&commands.push({name:"\u0056\u004c\u0043\u0020\u4e0b\u8f09\u0020\u0028\u0020\u0069\u004f\u0053\u0020\u652f\u6301\u5916\u639b\u5b57\u5e55\u0020\u0029",id:"vlc_download",icon:"download"})&&commands.push({name:"\u006e\u0050\u006c\u0061\u0079\u0065\u0072\u0020\u64ad\u653e\u0020\u0028\u0020\u0069\u004f\u0053\u0020\u0029",id:"nplayer_play",icon:"play_arrow"})&&commands.push({name:"\u0056\u004c\u0043\u0020\u64ad\u653e\u0020\u0028\u0020\u0069\u004f\u0053\u0020\u652f\u6301\u5916\u639b\u5b57\u5e55\u0020\u0029",id:"vlc_play",icon:"play_arrow"})&&commands.push({name:"\u0049\u006e\u0066\u0075\u0073\u0065\u0020\u64ad\u653e\u0020\u0028\u0020\u0069\u004f\u0053\u002f\u006d\u0061\u0063\u004f\u0053\u0020\u0029",id:"infuse_play",icon:"play_arrow"})&&commands.push({name:"\u0049\u0049\u004e\u0041\u0020\u64ad\u653e\u0020\u0028\u0020\u006d\u0061\u0063\u004f\u0053\u0020\u0029",id:"iina_play",icon:"play_arrow"})&&commands.push({name:"\u004d\u006f\u0076\u0069\u0073\u0074\u0020\u0050\u0072\u006f\u0020\u64ad\u653e\u0020\u0028\u0020\u006d\u0061\u0063\u004f\u0053\u0020\u0029",id:"movist_pro_play",icon:"play_arrow"}),"MediaStream"===item.Type&&item.IsExternal&&"Subtitle"===item.StreamType&&appHost.supports("filedownload")';
    body = body.replace(find, replace);
